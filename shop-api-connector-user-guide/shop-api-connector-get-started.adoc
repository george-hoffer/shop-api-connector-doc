...
== Common Use Cases For the Connector
 ...
 Please check the https://github.com/Apisero-Connectors/shop-api-connector-doc/blob/master/shop-api-connector-user-guide/shop-api-connector-get-started.adoc[Examples] for the simple use cases
