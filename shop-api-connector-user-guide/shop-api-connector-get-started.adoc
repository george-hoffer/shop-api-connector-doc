...
connect to APIs and resources on external systems, such as Salesforce, Shop API Connector, ServiceNow,
and Twitter. It acts as an middleware between to Systems.
...
The Shop API Connector enables the user to access the OCAPI by using certain configurations and access the data, manipulate the data and delete the data if required.
