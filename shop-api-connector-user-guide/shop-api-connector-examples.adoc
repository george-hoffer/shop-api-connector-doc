...
In this use case we are explaining the use of Shop API Connector for creating a basket as a guest and registering the guest after completion of post order. Here is the detailed information of each step for your reference.
